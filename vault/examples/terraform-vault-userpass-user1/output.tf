output "vault_creds_secret_path" {
  ...
  value       = module.terraform-vault-userpass-user1.vault_creds_secret_path
}

output "vault_creds_policy" {
  description = "The name of the created policy"
  value       = module.terraform-vault-userpass-user1.vault_creds_policy
}

output "vault_user" {
  description = "The created user in the userpass authentication backend"
  value       = module.terraform-vault-userpass-user1.vault_user
}
